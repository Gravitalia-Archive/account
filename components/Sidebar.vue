<template>
    <button @click="isSideBarOpened = !isSideBarOpened" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
    ...
    <aside :class="isSideBarOpened ? 'fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 transform-none' : 'fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 -translate-x-full'" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-zinc-900">
            <ul class="space-y-2 font-medium">
                <!-- Logo -->
                <div class="flex pb-4">
                    <img src="/favicon.webp" alt="" class="w-8" />
                    <h2 class="pl-2 font-bold text-xl">Gravitalia</h2>
                    
                    <button @click="isSideBarOpened = false" type="button" class="block md:hidden ml-auto mt-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="flex-shrink-0 w-5 h-5 fill-gray-500 transition duration-75 dark:fill-gray-400 group-hover:fill-gray-900 dark:group-hover:fill-white">
                ...
                <!-- Links -->
                <li>
                    <NuxtLink to="/" prefetch :class="path === '/' ? 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-100 dark:bg-gray-700 group' : 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group'">
                ...
                <li>
                    <NuxtLink to="/security" :class="path === '/security' ? 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-100 dark:bg-gray-700 group' : 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group'">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="flex-shrink-0 w-6 h-6 fill-gray-500 transition duration-75 dark:fill-gray-400 group-hover:fill-gray-900 dark:group-hover:fill-white">
                        ...
                        <span class="ml-3">{{ $t("Security") }}</span>
                    </NuxtLink>
                </li>
                <li>
                    <NuxtLink to="/data" :class="path === '/data' ? 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-100 dark:bg-gray-700 group' : 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group'">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="flex-shrink-0 w-6 h-6 fill-gray-500 transition duration-75 dark:fill-gray-400 group-hover:fill-gray-900 dark:group-hover:fill-white">
                ...
                <li>
                    <NuxtLink to="/oauth" :class="path === '/oauth' ? 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-100 dark:bg-gray-700 group' : 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group'">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="flex-shrink-0 w-6 h-6 fill-gray-500 transition duration-75 dark:fill-gray-400 group-hover:fill-gray-900 dark:group-hover:fill-white">
            ...
            <div class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-700" role="alert">
